...
/**
 * @property Gateways\Abstract_Gateway $payment_method
 */
abstract class AbstractStripePayment extends AbstractPaymentMethodType {
	...
	/**
	 * @var Gateways\Abstract_Gateway|MagicPaymentMethod
	 */
	...
	public function get_payment_method_data() {
		return [
			...
			'totalLabel'            => __( 'Total', 'simple-secure-stripe' ),
			'isAdmin'               => is_admin(),
