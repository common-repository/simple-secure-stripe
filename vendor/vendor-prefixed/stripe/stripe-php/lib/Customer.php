 ...
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Account|\SimpleSecureWP\SimpleSecureStripe\Stripe\BankAccount|\SimpleSecureWP\SimpleSecureStripe\Stripe\Card|\SimpleSecureWP\SimpleSecureStripe\Stripe\Source $default_source <p>ID of the default payment source for the customer.</p><p>If you are using payment methods created via the PaymentMethods API, see the <a href="https://stripe.com/docs/api/customers/object#customer_object-invoice_settings-default_payment_method">invoice_settings.default_payment_method</a> field instead.</p>
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\Discount $discount Describes the current discount active on the customer, if there is one.
 * @property null|string $email The customer's email address.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $invoice_credit_balance The current multi-currency balances, if any, being stored on the customer. If positive in a currency, the customer has a credit to apply to their next invoice denominated in that currency. If negative, the customer has an amount owed that will be added to their next invoice denominated in that currency. These balances do not refer to any unpaid invoices. They solely track amounts that have yet to be successfully applied to any invoice. A balance in a particular currency is only applied to any invoice as an invoice in that currency is finalized.
 * @property null|string $invoice_prefix The prefix for the customer used to generate unique invoice numbers.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $invoice_settings
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $shipping Mailing and shipping address for the customer. Appears on invoices emailed to this customer.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\Collection<\Stripe\Account|\SimpleSecureWP\SimpleSecureStripe\Stripe\BankAccount|\SimpleSecureWP\SimpleSecureStripe\Stripe\Card|\SimpleSecureWP\SimpleSecureStripe\Stripe\Source> $sources The customer's payment sources, if any.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\Collection<\Stripe\Subscription> $subscriptions The customer's current subscriptions, if any.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $tax
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\Collection<\Stripe\TaxId> $tax_ids The customer's tax IDs.
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\TestHelpers\TestClock $test_clock ID of the test clock this customer belongs to.
 *
 * @license MIT
...
class Customer extends ApiResource
{
     ...
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\Customer the updated customer
     */
     ...
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\Collection<\Stripe\PaymentMethod> list of payment methods
     */
     ...
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\PaymentMethod the retrieved payment method
     */
    public function retrievePaymentMethod($payment_method, $params = null, $opts = null)
    {
        ...
        $obj = \SimpleSecureWP\SimpleSecureStripe\Stripe\Util\Util::convertToStripeObject($response, $opts);
        $obj->setLastResponse($response);
     ...
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\SearchResult<\Stripe\Customer> the customer search results
     */
     ...
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\CashBalance
     */
     ...
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\Collection<\Stripe\CustomerBalanceTransaction> the list of customer balance transactions
     */
     ...
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\CustomerBalanceTransaction
     */
     ...
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\Collection<\Stripe\CustomerCashBalanceTransaction> the list of customer cash balance transactions
     */
     ...
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\CustomerCashBalanceTransaction
     */
     ...
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\Collection<\Stripe\BankAccount|\SimpleSecureWP\SimpleSecureStripe\Stripe\Card|\SimpleSecureWP\SimpleSecureStripe\Stripe\Source> the list of payment sources (BankAccount, Card or Source)
     */
     ...
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\BankAccount|\SimpleSecureWP\SimpleSecureStripe\Stripe\Card|\SimpleSecureWP\SimpleSecureStripe\Stripe\Source
     */
     ...
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\Collection<\Stripe\TaxId> the list of tax ids
     */
     ...
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\TaxId
     */
