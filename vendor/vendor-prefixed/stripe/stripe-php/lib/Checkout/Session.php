...
namespace SimpleSecureWP\SimpleSecureStripe\Stripe\Checkout;
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $after_expiration When set, provides configuration for actions to take if this Checkout Session expires.
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $consent Results of <code>consent_collection</code> for this session.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $consent_collection When set, provides configuration for the Checkout Session to gather active consent from customers.
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property null|string $currency Three-letter <a href="https://www.iso.org/iso-4217-currency-codes.html">ISO currency code</a>, in lowercase. Must be a <a href="https://stripe.com/docs/currencies">supported currency</a>.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $currency_conversion Currency conversion details for automatic currency conversion sessions
 * @property \SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject[] $custom_fields Collect additional information from your customer using custom fields. Up to 2 fields are supported.
 * @property \SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $custom_text
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Customer $customer The ID of the customer for this Session. For Checkout Sessions in <code>payment</code> or <code>subscription</code> mode, Checkout will create a new customer object based on information provided during the payment flow unless an existing customer was provided when the Session was created.
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $customer_details The customer details including the customer's tax exempt status and the customer's tax IDs. Only the customer's email is present on Sessions in <code>setup</code> mode.
 ...
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Invoice $invoice ID of the invoice created by the Checkout Session, if it exists.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $invoice_creation Details on the state of invoice creation for the Checkout Session.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\Collection<\Stripe\LineItem> $line_items The line items purchased by the customer.
 ...
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\PaymentIntent $payment_intent The ID of the PaymentIntent for Checkout Sessions in <code>payment</code> mode.
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\PaymentLink $payment_link The ID of the Payment Link that created this Session.
 * @property null|string $payment_method_collection Configure whether a Checkout Session should collect a payment method.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $payment_method_configuration_details Information about the payment method configuration used for this Checkout session.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $payment_method_options Payment-method-specific configuration for the PaymentIntent or SetupIntent of this CheckoutSession.
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $phone_number_collection
 * @property null|string $recovered_from The ID of the original expired Checkout Session that triggered the recovery flow.
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\SetupIntent $setup_intent The ID of the SetupIntent for Checkout Sessions in <code>setup</code> mode.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $shipping_address_collection When set, provides configuration for Checkout to collect a shipping address from a customer.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $shipping_cost The details of the customer cost of shipping, including the customer chosen ShippingRate.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $shipping_details Shipping information for this Checkout Session.
 * @property \SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject[] $shipping_options The shipping rate options applied to this Session.
 ...
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Subscription $subscription The ID of the subscription for Checkout Sessions in <code>subscription</code> mode.
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $tax_id_collection
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $total_details Tax and discount details for the computed total amount.
...
class Session extends \SimpleSecureWP\SimpleSecureStripe\Stripe\ApiResource
{
     ...
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\Checkout\Session the expired session
     */
     ...
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\Collection<\Stripe\LineItem> list of line items
     */
