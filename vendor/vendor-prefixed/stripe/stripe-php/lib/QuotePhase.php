 ...
 * @property null|(string|\SimpleSecureWP\SimpleSecureStripe\Stripe\TaxRate)[] $default_tax_rates The default tax rates to apply to the subscription during this phase of the quote.
 * @property (string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Discount)[] $discounts The stackable discounts that will be applied to the subscription on this phase. Subscription item discounts are applied before subscription discounts.
 * @property null|int $end_date The end of this phase of the quote
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $invoice_settings The invoice settings applicable during this phase.
