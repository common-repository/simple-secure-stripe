 ...
 * @property string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Customer $customer ID of the customer.
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\CustomerBalanceTransaction $customer_balance_transaction Customer balance transaction related to this credit note.
 ...
 * @property \SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject[] $discount_amounts The aggregate amounts calculated per discount for all line items.
 ...
 * @property string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Invoice $invoice ID of the invoice.
 * @property \SimpleSecureWP\SimpleSecureStripe\Stripe\Collection<\Stripe\CreditNoteLineItem> $lines Line items that make up the credit note
 ...
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Refund $refund Refund related to this credit note.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $shipping_cost The details of the cost of shipping, including the ShippingRate applied to the invoice.
 ...
 * @property \SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject[] $tax_amounts The aggregate amounts calculated per tax rate for all line items.
...
class CreditNote extends ApiResource
{
     ...
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\CreditNote the previewed credit note
     */
     ...
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\Collection<\Stripe\CreditNoteLineItem> list of credit note line items
     */
     ...
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\CreditNote the voided credit note
     */
     ...
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\Collection<\Stripe\CreditNoteLineItem> the list of credit note line items
     */
