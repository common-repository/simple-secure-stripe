 ...
 * @property \SimpleSecureWP\SimpleSecureStripe\Stripe\BalanceTransaction[] $balance_transactions List of zero, one, or two balance transactions that show funds withdrawn and reinstated to your Stripe account as a result of this dispute.
 * @property string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Charge $charge ID of the charge that was disputed.
 ...
 * @property \SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $evidence_details
 ...
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\PaymentIntent $payment_intent ID of the PaymentIntent that was disputed.
...
class Dispute extends ApiResource
{
     ...
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\Dispute the closed dispute
     */
