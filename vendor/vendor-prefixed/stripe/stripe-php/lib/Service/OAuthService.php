...
class OAuthService extends \SimpleSecureWP\SimpleSecureStripe\Stripe\Service\AbstractService
{
    /**
     ...
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject the object returned by Stripe's Connect API
     */
    ...
    public function authorizeUrl($params = null, $opts = null)
    {
        ...
        $query = \SimpleSecureWP\SimpleSecureStripe\Stripe\Util\Util::encodeParameters($params);
     ...
     * @param null|array $opts
     *
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\OAuth\OAuthErrorException if the request fails
     *
    ...
    private function _getClientId($params = null)
    {
        ...
        if (null === $clientId) {
            $msg = 'No client_id provided. (HINT: set your client_id using '
              . '`new \SimpleSecureWP\SimpleSecureStripe\Stripe\StripeClient([clientId => <CLIENT-ID>
     ...
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\Util\RequestOptions
     */
    private function _parseOpts($opts)
    {
        if (\is_array($opts)) {
            if (\array_key_exists('connect_base', $opts)) {
                ...
                throw new \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\InvalidArgumentException('Use `api_base`, not `connect_base`');
            }
        }

        return \SimpleSecureWP\SimpleSecureStripe\Stripe\Util\RequestOptions::parse($opts);
    }
