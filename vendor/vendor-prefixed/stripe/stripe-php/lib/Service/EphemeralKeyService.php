...
class EphemeralKeyService extends \SimpleSecureWP\SimpleSecureStripe\Stripe\Service\AbstractService
{
    /**
     ...
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\EphemeralKey
     *
     * @license MIT
    ...
    public function create($params = null, $opts = null)
    {
        if (!$opts || !isset($opts['stripe_version'])) {
            throw new \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\InvalidArgumentException('stripe_version must be specified to create an ephemeral key');
        }
