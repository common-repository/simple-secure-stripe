 ...
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $application ID of the Connect application that created the SetupIntent.
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $automatic_payment_methods Settings for automatic payment methods compatible with this Setup Intent
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $last_setup_error The error encountered in the previous SetupIntent confirmation.
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\SetupAttempt $latest_attempt The most recent SetupAttempt for this SetupIntent.
 * @property bool $livemode Has the value <code>true</code> if the object exists in live mode or the value <code>false</code> if the object exists in test mode.
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Mandate $mandate ID of the multi use Mandate generated by the SetupIntent.
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $next_action If present, this property tells you what actions you need to take in order for your customer to continue payment setup.
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Account $on_behalf_of The account (if any) for which the setup is intended.
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\PaymentMethod $payment_method ID of the payment method used with this SetupIntent.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $payment_method_configuration_details Information about the payment method configuration used for this Setup Intent.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $payment_method_options Payment-method-specific configuration for this SetupIntent.
 ...
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Mandate $single_use_mandate ID of the single_use Mandate generated by the SetupIntent.
...
class SetupIntent extends ApiResource
{
     ...
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\SetupIntent the canceled setup intent
     */
     ...
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\SetupIntent the confirmed setup intent
     */
     ...
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\SetupIntent the verified setup intent
     */
