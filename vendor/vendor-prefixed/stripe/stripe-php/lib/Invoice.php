 ...
 * @property null|(string|\SimpleSecureWP\SimpleSecureStripe\Stripe\TaxId)[] $account_tax_ids The account tax IDs associated with the invoice. Only editable when the invoice is a draft.
 ...
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $application ID of the Connect Application that created the invoice.
 ...
 * @property \SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $automatic_tax
 ...
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Charge $charge ID of the latest charge generated for this invoice, if any.
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject[] $custom_fields Custom fields displayed on the invoice.
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Customer $customer The ID of the customer who will be billed.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $customer_address The customer's address. Until the invoice is finalized, this field will equal <code>customer.address</code>. Once the invoice is finalized, this field will no longer be updated.
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $customer_shipping The customer's shipping information. Until the invoice is finalized, this field will equal <code>customer.shipping</code>. Once the invoice is finalized, this field will no longer be updated.
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject[] $customer_tax_ids The customer's tax IDs. Until the invoice is finalized, this field will contain the same tax IDs as <code>customer.tax_ids</code>. Once the invoice is finalized, this field will no longer be updated.
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\PaymentMethod $default_payment_method ID of the default payment method for the invoice. It must belong to the customer associated with the invoice. If not set, defaults to the subscription's default payment method, if any, or to the default payment method in the customer's invoice settings.
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Account|\SimpleSecureWP\SimpleSecureStripe\Stripe\BankAccount|\SimpleSecureWP\SimpleSecureStripe\Stripe\Card|\SimpleSecureWP\SimpleSecureStripe\Stripe\Source $default_source ID of the default payment source for the invoice. It must belong to the customer associated with the invoice and be in a chargeable state. If not set, defaults to the subscription's default source, if any, or to the customer's default source.
 * @property \SimpleSecureWP\SimpleSecureStripe\Stripe\TaxRate[] $default_tax_rates The tax rates applied to this invoice, if any.
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\Discount $discount Describes the current discount applied to this invoice, if there is one. Not populated if there are multiple discounts.
 * @property null|(string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Discount)[] $discounts The discounts applied to the invoice. Line item discounts are applied before invoice discounts. Use <code>expand[]=discounts</code> to expand each discount.
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $from_invoice Details of the invoice that was cloned. See the <a href="https://stripe.com/docs/invoicing/invoice-revisions">revision documentation</a> for more details.
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $last_finalization_error The error encountered during the previous attempt to finalize the invoice. This field is cleared when the invoice is successfully finalized.
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Invoice $latest_revision The ID of the most recent non-draft revision of this invoice
 * @property \SimpleSecureWP\SimpleSecureStripe\Stripe\Collection<\Stripe\InvoiceLineItem> $lines The individual line items that make up the invoice. <code>lines</code> is sorted as follows: (1) pending invoice items (including prorations) in reverse chronological order, (2) subscription items in reverse chronological order, and (3) invoice items added after invoice creation in chronological order.
 ...
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\PaymentIntent $payment_intent The PaymentIntent associated with this invoice. The PaymentIntent is generated when the invoice is finalized, and can then be used to pay the invoice. Note that voiding an invoice will cancel the PaymentIntent.
 * @property \SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $payment_settings
 ...
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Quote $quote The quote this invoice was generated from.
 * @property null|string $receipt_number This is the transaction number that appears on email receipts sent for this invoice.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $rendering_options Options for invoice PDF rendering.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $shipping_cost The details of the cost of shipping, including the ShippingRate applied on the invoice.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $shipping_details Shipping details for the invoice. The Invoice PDF will use the <code>shipping_details</code> value if it is set, otherwise the PDF will render the shipping address from the customer.
 ...
 * @property \SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $status_transitions
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Subscription $subscription The subscription that this invoice was prepared for, if any.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $subscription_details Details about the subscription that created this invoice.
 ...
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\TestHelpers\TestClock $test_clock ID of the test clock this invoice belongs to.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $threshold_reason
 * @property int $total Total after discounts and taxes.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject[] $total_discount_amounts The aggregate amounts calculated per discount across all line items.
 ...
 * @property \SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject[] $total_tax_amounts The aggregate amounts calculated per tax rate for all line items.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $transfer_data The account (if any) the payment will be attributed to for tax reporting, and where funds from the payment will be transferred to for the invoice.
...
class Invoice extends ApiResource
{
     ...
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\Invoice the finalized invoice
     */
     ...
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\Invoice the uncollectible invoice
     */
     ...
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\Invoice the paid invoice
     */
     ...
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\Invoice the sent invoice
     */
     ...
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\Invoice the upcoming invoice
     */
     ...
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\Collection<\Stripe\InvoiceLineItem> list of invoice line items
     */
     ...
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\Invoice the voided invoice
     */
     ...
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\SearchResult<\Stripe\Invoice> the invoice search results
     */
     ...
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\Collection<\Stripe\LineItem> the list of line items
     */
