...
namespace SimpleSecureWP\SimpleSecureStripe\Stripe\BillingPortal;
 ...
 * @property string|\SimpleSecureWP\SimpleSecureStripe\Stripe\BillingPortal\Configuration $configuration The configuration used by this session, describing the features available.
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property string $customer The ID of the customer for this session.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $flow Information about a specific flow for the customer to go through. See the <a href="https://stripe.com/docs/customer-management/portal-deep-links">docs</a> to learn more about using customer portal deep links and flows.
