 ...
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Account $account The ID of the account that the bank account is associated with.
 ...
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Customer $customer The ID of the customer that the bank account is associated with.
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $future_requirements Information about upcoming new requirements for the bank account, including what information needs to be collected.
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $requirements Information about the requirements for the bank account, including what information needs to be collected.
