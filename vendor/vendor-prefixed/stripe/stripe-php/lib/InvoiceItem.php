 ...
 * @property string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Customer $customer The ID of the customer who will be billed when this invoice item is billed.
 ...
 * @property null|(string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Discount)[] $discounts The discounts which apply to the invoice item. Item discounts are applied before invoice discounts. Use <code>expand[]=discounts</code> to expand each discount.
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Invoice $invoice The ID of the invoice this invoice item belongs to.
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\Plan $plan If the invoice item is a proration, the plan of the subscription that the proration was computed for.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\Price $price The price of the invoice item.
 ...
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Subscription $subscription The subscription that this invoice item has been created for, if any.
 * @property null|string $subscription_item The subscription item that this invoice item has been created for, if any.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\TaxRate[] $tax_rates The tax rates which apply to the invoice item. When set, the <code>default_tax_rates</code> on the invoice do not apply to this invoice item.
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\TestHelpers\TestClock $test_clock ID of the test clock this invoice item belongs to.
