 ...
 * @property \SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $balance Balance information for the FinancialAccount
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\Treasury\FinancialAccountFeatures $features Encodes whether a FinancialAccount has access to a particular Feature, with a <code>status</code> enum and associated <code>status_details</code>. Stripe or the platform can control Features via the requested field.
 * @property \SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject[] $financial_addresses The set of credentials that resolve to a FinancialAccount.
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $platform_restrictions The set of functionalities that the platform can restrict on the FinancialAccount.
 ...
 */
class FinancialAccount extends \SimpleSecureWP\SimpleSecureStripe\Stripe\ApiResource
{
     ...
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\Treasury\FinancialAccountFeatures the retrieved financial account features
     */
     ...
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\Treasury\FinancialAccountFeatures the updated financial account features
     */
