...
class DefaultLogger implements LoggerInterface
{
    ...
    {
        if (\count($context) > 0) {
            throw new \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\BadMethodCallException('DefaultLogger does not currently implement context. Please implement if you need it.');
        }
