 ...
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $application ID of the Connect application that created the Order, if any.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $automatic_tax
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $billing_details Customer billing details associated with the order.
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject[] $credits The credits applied to the Order. At most 10 credits can be applied to an Order.
 * @property string $currency Three-letter <a href="https://www.iso.org/iso-4217-currency-codes.html">ISO currency code</a>, in lowercase. Must be a <a href="https://stripe.com/docs/currencies">supported currency</a>.
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Customer $customer The customer which this orders belongs to.
 * @property null|string $description An arbitrary string attached to the object. Often useful for displaying to users.
 * @property null|(string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Discount)[] $discounts The discounts applied to the order. Use <code>expand[]=discounts</code> to expand each discount.
 * @property null|string $ip_address A recent IP address of the purchaser used for tax reporting and tax location inference.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\Collection<\Stripe\LineItem> $line_items A list of line items the customer is ordering. Each line item includes information about the product, the quantity, and the resulting cost. There is a maximum of 100 line items.
 ...
 * @property \SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $payment
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $shipping_details Customer shipping information associated with the order.
 * @property string $status The overall status of the order.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $tax_details
...
class Order extends ApiResource
{
     ...
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\Order the canceled order
     */
     ...
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\Order the reopened order
     */
     ...
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\Order the submited order
     */
