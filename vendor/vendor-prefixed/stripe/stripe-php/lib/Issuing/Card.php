 ...
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Issuing\Card $replaced_by The latest card that replaces this card, if any.
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Issuing\Card $replacement_for The card this card replaces, if any.
 * @property null|string $replacement_reason The reason why the previous card needed to be replaced.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $shipping Where and how the card will be shipped.
 * @property \SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $spending_controls
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $wallets Information relating to digital wallets (like Apple Pay and Google Pay).
 *
 * @license MIT
