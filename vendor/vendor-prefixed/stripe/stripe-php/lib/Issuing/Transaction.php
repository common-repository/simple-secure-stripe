 ...
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Issuing\Authorization $authorization The <code>Authorization</code> object that led to this transaction.
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\BalanceTransaction $balance_transaction ID of the <a href="https://stripe.com/docs/api/balance_transactions">balance transaction</a> associated with this transaction.
 * @property string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Issuing\Card $card The card used to make this transaction.
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Issuing\Cardholder $cardholder The cardholder to whom this transaction belongs.
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property string $currency Three-letter <a href="https://www.iso.org/iso-4217-currency-codes.html">ISO currency code</a>, in lowercase. Must be a <a href="https://stripe.com/docs/currencies">supported currency</a>.
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Issuing\Dispute $dispute If you've disputed the transaction, the ID of the dispute.
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $network_data Details about the transaction, such as processing dates, set by the card network.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $purchase_details Additional purchase information that is optionally provided by the merchant.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $treasury <a href="https://stripe.com/docs/api/treasury">Treasury</a> details related to this transaction if it was created on a [FinancialAccount](/docs/api/treasury/financial_accounts
 ...
 */
class Transaction extends \SimpleSecureWP\SimpleSecureStripe\Stripe\ApiResource
{
