...
trait Request
{
     ...
     *
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\InvalidArgumentException if $params exists and is not an array
     */
    protected static function _validateParams($params = null)
    {
        if ($params && !\is_array($params)) {
            $message = 'You must pass an array as the first argument to Stripe API '
               ...
               . "would be: \"SimpleSecureWP\SimpleSecureStripe\Stripe\\Charge::create(['amount' => 100, "
               . "'currency' => 'usd', 'source' => 'tok_1234'])\")";

            throw new \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\InvalidArgumentException($message);
        }
    }
    ...
    {
        $opts = \SimpleSecureWP\SimpleSecureStripe\Stripe\Util\RequestOptions::parse($options);
        $baseUrl = isset($opts->apiBase) ? $opts->apiBase : static::baseUrl();
        $requestor = new \SimpleSecureWP\SimpleSecureStripe\Stripe\ApiRequestor($opts->apiKey, $baseUrl);
