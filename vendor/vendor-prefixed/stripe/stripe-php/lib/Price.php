 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $currency_options Prices defined in each available currency option. Each key must be a three-letter <a href="https://www.iso.org/iso-4217-currency-codes.html">ISO currency code</a> and a <a href="https://stripe.com/docs/currencies">supported currency</a>.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $custom_unit_amount When set, provides configuration for the amount to be adjusted by the customer during Checkout Sessions and Payment Links.
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $migrate_to Subscriptions using this price will be migrated to use the new referenced price.
 * @property null|string $nickname A brief description of the price, hidden from customers.
 * @property string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Product $product The ID of the product this price is associated with.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $recurring The recurring components of a price such as <code>interval</code> and <code>usage_type</code>.
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject[] $tiers Each element represents a pricing tier. This parameter requires <code>billing_scheme</code> to be set to <code>tiered</code>. See also the documentation for <code>billing_scheme</code>.
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $transform_quantity Apply a transformation to the reported usage or set quantity before computing the amount billed. Cannot be combined with <code>tiers</code>.
...
class Price extends ApiResource
{
     ...
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\SearchResult<\Stripe\Price> the price search results
     */
