 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $last_error If present, this property tells you the last error encountered when processing the verification.
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Identity\VerificationReport $last_verification_report ID of the most recent VerificationReport. <a href="https://stripe.com/docs/identity/verification-sessions#results">Learn more about accessing detailed verification results.</a>
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $options A set of options for the session’s verification checks.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $redaction Redaction status of this VerificationSession. If the VerificationSession is not redacted, this field will be null.
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $verified_outputs The user’s verified data.
 *
 * @license MIT
 * Modified by sswp-bot on 26-December-2023 using Strauss.
 * @see https://github.com/BrianHenryIE/strauss
 */
class VerificationSession extends \SimpleSecureWP\SimpleSecureStripe\Stripe\ApiResource
{
     ...
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\Identity\VerificationSession the canceled verification session
     */
     ...
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\Identity\VerificationSession the redacted verification session
     */
