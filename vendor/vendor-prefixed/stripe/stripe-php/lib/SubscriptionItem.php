 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $billing_thresholds Define thresholds at which an invoice will be sent, and the related subscription advanced to a new billing period
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property null|(string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Discount)[] $discounts The discounts applied to the subscription item. Subscription item discounts are applied before subscription discounts. Use <code>expand[]=discounts</code> to expand each discount.
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\TaxRate[] $tax_rates The tax rates which apply to this <code>subscription_item</code>. When set, the <code>default_tax_rates</code> on the subscription do not apply to this <code>subscription_item</code>.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $trial Options that configure the trial on the subscription item.
 *
 * @license MIT
...
class SubscriptionItem extends ApiResource
{
     ...
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\UsageRecord
     */
     ...
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\Collection<\Stripe\UsageRecordSummary> the list of usage record summaries
     */
