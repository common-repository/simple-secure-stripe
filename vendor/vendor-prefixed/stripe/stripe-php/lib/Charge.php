 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $alternate_statement_descriptors
 ...
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $application ID of the Connect application that created the charge.
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\ApplicationFee $application_fee The application fee (if any) for the charge. <a href="https://stripe.com/docs/connect/direct-charges#collecting-fees">See the Connect documentation</a> for details.
 ...
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\BalanceTransaction $balance_transaction ID of the balance transaction that describes the impact of this charge on your account balance (not including refunds or disputes).
 ...
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Customer $customer ID of the customer this charge is for if one exists.
 * @property null|string $description An arbitrary string attached to the object. Often useful for displaying to users.
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Account $destination ID of an existing, connected Stripe account to transfer funds to if <code>transfer_data</code> was specified in the charge request.
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Dispute $dispute Details about the dispute if the charge has been disputed.
 * @property bool $disputed Whether the charge has been disputed.
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\BalanceTransaction $failure_balance_transaction ID of the balance transaction that describes the reversal of the balance on your account due to payment failure.
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $fraud_details Information on fraud assessments for the charge.
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Invoice $invoice ID of the invoice this charge is for if one exists.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $level3
 ...
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Account $on_behalf_of The account (if any) the charge was made on behalf of without triggering an automatic transfer. See the <a href="https://stripe.com/docs/connect/separate-charges-and-transfers">Connect documentation</a> for details.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $outcome Details about whether the payment was accepted, and why. See <a href="https://stripe.com/docs/declines">understanding declines</a> for details.
 * @property bool $paid <code>true</code> if the charge succeeded, or was successfully authorized for later capture.
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\PaymentIntent $payment_intent ID of the PaymentIntent associated with this charge, if one exists.
 * @property null|string $payment_method ID of the payment method used in this charge.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $payment_method_details Details about the payment method at the time of the transaction.
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\Collection<\Stripe\Refund> $refunds A list of refunds that have been applied to the charge.
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Review $review ID of the review associated with this charge if one exists.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $shipping Shipping information for the charge.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\Account|\SimpleSecureWP\SimpleSecureStripe\Stripe\BankAccount|\SimpleSecureWP\SimpleSecureStripe\Stripe\Card|\SimpleSecureWP\SimpleSecureStripe\Stripe\Source $source This is a legacy field that will be removed in the future. It contains the Source, Card, or BankAccount object used for the charge. For details about the payment method used for this charge, refer to <code>payment_method</code> or <code>payment_method_details</code> instead.
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Transfer $source_transfer The transfer ID which created this charge. Only present if the charge came from another Stripe account. <a href="https://stripe.com/docs/connect/destination-charges">See the Connect documentation</a> for details.
 ...
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Transfer $transfer ID of the transfer to the <code>destination</code> account (only applicable if the charge was created using the <code>destination</code> parameter).
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $transfer_data An optional dictionary including the account to automatically transfer to as part of a destination charge. <a href="https://stripe.com/docs/connect/destination-charges">See the Connect documentation</a> for details.
...
class Charge extends ApiResource
{
     ...
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\Charge the captured charge
     */
     ...
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\SearchResult<\Stripe\Charge> the charge search results
     */
