...
class EphemeralKey extends ApiResource
{
     ...
     *
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\InvalidArgumentException if stripe_version is missing
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\EphemeralKey the created key
     */
