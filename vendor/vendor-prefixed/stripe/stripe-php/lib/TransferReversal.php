 ...
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\BalanceTransaction $balance_transaction Balance transaction that describes the impact on your account balance.
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property string $currency Three-letter <a href="https://www.iso.org/iso-4217-currency-codes.html">ISO currency code</a>, in lowercase. Must be a <a href="https://stripe.com/docs/currencies">supported currency</a>.
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Refund $destination_payment_refund Linked payment refund for the transfer reversal.
 ...
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Refund $source_refund ID of the refund responsible for the transfer reversal.
 * @property string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Transfer $transfer ID of the transfer that was reversed.
 *
 * @license MIT
