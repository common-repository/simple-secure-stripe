 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $address
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $address_kana The Kana variation of the person's address (Japan only).
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $address_kanji The Kanji variation of the person's address (Japan only).
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $dob
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $future_requirements Information about the upcoming new requirements for this person, including what information needs to be collected, and by when.
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $registered_address
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $relationship
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $requirements Information about the requirements for this person, including what information needs to be collected, and by when.
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $verification
 *
 * @license MIT
...
class Person extends ApiResource
{
     ...
     *
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\BadMethodCallException
     */
