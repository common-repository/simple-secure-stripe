 ...
 * @property \SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $data
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $request Information on the API request that instigated the event.
