...
use SimpleSecureWP\SimpleSecureStripe\Stripe\Exception;
use SimpleSecureWP\SimpleSecureStripe\Stripe\Stripe;
use SimpleSecureWP\SimpleSecureStripe\Stripe\Util;
...
class CurlClient implements ClientInterface, StreamingClientInterface
{
    ...
    /** @var \SimpleSecureWP\SimpleSecureStripe\Stripe\Util\RandomGenerator */
     ...
     * @param null|\SimpleSecureWP\SimpleSecureStripe\Stripe\Util\RandomGenerator $randomGenerator
     */
     ...
     * @param int $errno
     * @param int $rcode
     * @param array|\SimpleSecureWP\SimpleSecureStripe\Stripe\Util\CaseInsensitiveArray $rheaders
     * @param int $numRetries
     *
     * @return bool
     */
