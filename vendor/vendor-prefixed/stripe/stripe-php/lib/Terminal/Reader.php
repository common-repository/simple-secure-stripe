 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $action The most recent action performed by the reader.
 ...
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Terminal\Location $location The location identifier of the reader.
 ...
 */
class Reader extends \SimpleSecureWP\SimpleSecureStripe\Stripe\ApiResource
{
     ...
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\Terminal\Reader the canceled reader
     */
     ...
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\Terminal\Reader the collected reader
     */
     ...
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\Terminal\Reader the confirmed reader
     */
     ...
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\Terminal\Reader the processed reader
     */
     ...
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\Terminal\Reader the refunded reader
     */
     ...
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\Terminal\Reader the seted reader
     */
