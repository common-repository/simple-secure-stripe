 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $amount_details
 * @property int $amount_received Amount that was collected by this PaymentIntent.
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $application ID of the Connect application that created the PaymentIntent.
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $automatic_payment_methods Settings to configure compatible payment methods from the <a href="https://dashboard.stripe.com/settings/payment_methods">Stripe Dashboard</a>
 ...
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Invoice $invoice ID of the invoice that created this PaymentIntent, if it exists.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $last_payment_error The payment error encountered in the previous PaymentIntent confirmation. It will be cleared if the PaymentIntent is later updated for any reason.
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Charge $latest_charge The latest charge created by this payment intent.
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $next_action If present, this property tells you what actions you need to take in order for your customer to fulfill a payment using the provided source.
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Account $on_behalf_of The account (if any) for which the funds of the PaymentIntent are intended. See the PaymentIntents <a href="https://stripe.com/docs/payments/connected-accounts">use case for connected accounts</a> for details.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $payment_details
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\PaymentMethod $payment_method ID of the payment method used in this PaymentIntent.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $payment_method_configuration_details Information about the payment method configuration used for this PaymentIntent.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $payment_method_options Payment-method-specific configuration for this PaymentIntent.
 * @property string[] $payment_method_types The list of payment method types (e.g. card) that this PaymentIntent is allowed to use.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $processing If present, this property tells you about the processing state of the payment.
 ...
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Review $review ID of the review associated with this PaymentIntent, if any.
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $shipping Shipping information for this PaymentIntent.
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $transfer_data The data with which to automatically create a Transfer when the payment is finalized. See the PaymentIntents <a href="https://stripe.com/docs/payments/connected-accounts">use case for connected accounts</a> for details.
...
class PaymentIntent extends ApiResource
{
     ...
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\PaymentIntent the applied payment intent
     */
     ...
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\PaymentIntent the canceled payment intent
     */
     ...
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\PaymentIntent the captured payment intent
     */
     ...
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\PaymentIntent the confirmed payment intent
     */
     ...
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\PaymentIntent the incremented payment intent
     */
     ...
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\PaymentIntent the verified payment intent
     */
     ...
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\SearchResult<\Stripe\PaymentIntent> the payment intent search results
     */
