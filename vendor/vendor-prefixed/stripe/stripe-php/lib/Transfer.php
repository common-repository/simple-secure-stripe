 ...
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\BalanceTransaction $balance_transaction Balance transaction that describes the impact of this transfer on your account balance.
 ...
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Account $destination ID of the Stripe account the transfer was sent to.
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Charge $destination_payment If the destination is a Stripe account, this will be the ID of the payment that the destination account received for the transfer.
 ...
 * @property \SimpleSecureWP\SimpleSecureStripe\Stripe\Collection<\Stripe\TransferReversal> $reversals A list of reversals that have been applied to the transfer.
 ...
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Charge $source_transaction ID of the charge or payment that was used to fund the transfer. If null, the transfer was funded from the available balance.
...
class Transfer extends ApiResource
{
     ...
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\Collection<\Stripe\TransferReversal> the list of transfer reversals
     */
