 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $ach_credit_transfer
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $ach_debit
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $code_verification
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $owner Information about the owner of the payment instrument that may be used or required by particular source types.
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $receiver
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $redirect
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $sepa_credit_transfer
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $source_order
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $three_d_secure
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $wechat
 *
 * @license MIT
...
class Source extends ApiResource
{
     ...
     *
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\UnexpectedValueException if the source is not attached to a customer
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\Source the detached source
     */
     ...
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\Collection<\Stripe\SourceTransaction> list of source transactions
     */
     ...
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\Source the verified source
     */
