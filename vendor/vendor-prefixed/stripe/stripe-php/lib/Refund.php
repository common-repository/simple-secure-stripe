 ...
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Charge $charge ID of the charge that was refunded.
 ...
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\BalanceTransaction $failure_balance_transaction If the refund failed, this balance transaction describes the adjustment made on your account balance that reverses the initial balance transaction.
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $next_action
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\PaymentIntent $payment_intent ID of the PaymentIntent that was refunded.
 ...
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\TransferReversal $source_transfer_reversal The transfer reversal that is associated with the refund. Only present if the charge came from another Stripe account. See the Connect documentation for details.
 ...
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\TransferReversal $transfer_reversal If the accompanying transfer was reversed, the transfer reversal object. Only applicable if the charge was created using the destination parameter.
 *
 * @license MIT
...
class Refund extends ApiResource
{
     ...
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\Refund the canceled refund
     */
