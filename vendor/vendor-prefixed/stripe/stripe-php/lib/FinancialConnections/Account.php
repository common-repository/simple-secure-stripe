 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $account_holder The account holder that this account belongs to.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $balance The most recent information about the account's balance.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $balance_refresh The state of the most recent attempt to refresh the account balance.
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $inferred_balances_refresh The state of the most recent attempt to refresh the account's inferred balance history.
 ...
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\FinancialConnections\AccountOwnership $ownership The most recent information about the account's owners.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $ownership_refresh The state of the most recent attempt to refresh the account owners.
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $transaction_refresh The state of the most recent attempt to refresh the account transactions.
 *
 * @license MIT
 * Modified by sswp-bot on 26-December-2023 using Strauss.
 * @see https://github.com/BrianHenryIE/strauss
 */
class Account extends \SimpleSecureWP\SimpleSecureStripe\Stripe\ApiResource
{
    const OBJECT_NAME = 'financial_connections.account';

    use \SimpleSecureWP\SimpleSecureStripe\Stripe\ApiOperations\All;
    use \SimpleSecureWP\SimpleSecureStripe\Stripe\ApiOperations\NestedResource;
     ...
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\FinancialConnections\Account the disconnected account
     */
     ...
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\Collection<\Stripe\FinancialConnections\AccountOwner> list of account owners
     */
     ...
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\FinancialConnections\Account the refreshed account
     */
     ...
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\FinancialConnections\Account the subscribed account
     */
     ...
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\FinancialConnections\Account the unsubscribed account
     */
     ...
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\Collection<\Stripe\FinancialConnections\InferredBalance> the list of financial connections account inferred balances
     */
