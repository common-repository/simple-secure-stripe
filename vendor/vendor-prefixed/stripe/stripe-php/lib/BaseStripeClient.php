...
class BaseStripeClient implements StripeClientInterface, StripeStreamingClientInterface
{
    ...
    /** @var \SimpleSecureWP\SimpleSecureStripe\Stripe\Util\RequestOptions */
    private $defaultOpts;

    /** @var \SimpleSecureWP\SimpleSecureStripe\Stripe\Preview */
    public $preview;
    ...
    public function __construct($config = [])
    {
        if (\is_string($config)) {
            ...
            throw new \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\InvalidArgumentException('$config must be a string or an array');
        }
        ...
        $this->defaultOpts = \SimpleSecureWP\SimpleSecureStripe\Stripe\Util\RequestOptions::parse([
    ...
    public function request($method, $path, $params, $opts)
    {
        ...
        $requestor = new \SimpleSecureWP\SimpleSecureStripe\Stripe\ApiRequestor($this->apiKeyForRequest($opts), $baseUrl);
     ...
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\ApiResponse
     */
    ...
    public function requestCollection($method, $path, $params, $opts)
    {
        ...
        if (!($obj instanceof \SimpleSecureWP\SimpleSecureStripe\Stripe\Collection)) {
            ...
            throw new \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\UnexpectedValueException($msg);
        }
    ...
    /**
     * @param \SimpleSecureWP\SimpleSecureStripe\Stripe\Util\RequestOptions $opts
     *
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\AuthenticationException
     *
     * @return string
     */
    private function apiKeyForRequest($opts)
    {
        ...
        if (null === $apiKey) {
            ...
            throw new \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\AuthenticationException($msg);
        }
     ...
     *
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\InvalidArgumentException
     */
    private function validateConfig($config)
    {
        // api_key
        if (null !== $config['api_key'] && !\is_string($config['api_key'])) {
            throw new \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\InvalidArgumentException('api_key must be null or a string');
        }
        ...
        if (null !== $config['client_id'] && !\is_string($config['client_id'])) {
            throw new \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\InvalidArgumentException('client_id must be null or a string');
        }

        // stripe_account
        if (null !== $config['stripe_account'] && !\is_string($config['stripe_account'])) {
            throw new \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\InvalidArgumentException('stripe_account must be null or a string');
        }

        // stripe_version
        if (null !== $config['stripe_version'] && !\is_string($config['stripe_version'])) {
            throw new \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\InvalidArgumentException('stripe_version must be null or a string');
        }

        // api_base
        if (!\is_string($config['api_base'])) {
            throw new \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\InvalidArgumentException('api_base must be a string');
        }

        // connect_base
        if (!\is_string($config['connect_base'])) {
            throw new \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\InvalidArgumentException('connect_base must be a string');
        }

        // files_base
        if (!\is_string($config['files_base'])) {
            throw new \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\InvalidArgumentException('files_base must be a string');
        }
        ...
        if (!empty($extraConfigKeys)) {
            ...
            throw new \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\InvalidArgumentException('Found unknown key(s) in configuration array: ' . $invalidKeys);
        }
    }
     ...
     * @param string $json
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject
     * */
    public function deserialize($json)
    {
        return \SimpleSecureWP\SimpleSecureStripe\Stripe\Util\Util::convertToStripeObject(\json_decode($json, true), []);
    }
}
