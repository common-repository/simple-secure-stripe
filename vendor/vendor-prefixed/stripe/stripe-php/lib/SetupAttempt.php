 ...
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $application The value of <a href="https://stripe.com/docs/api/setup_intents/object#setup_intent_object-application">application</a> on the SetupIntent at the time of this confirmation.
 ...
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Customer $customer The value of <a href="https://stripe.com/docs/api/setup_intents/object#setup_intent_object-customer">customer</a> on the SetupIntent at the time of this confirmation.
 ...
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Account $on_behalf_of The value of <a href="https://stripe.com/docs/api/setup_intents/object#setup_intent_object-on_behalf_of">on_behalf_of</a> on the SetupIntent at the time of this confirmation.
 * @property string|\SimpleSecureWP\SimpleSecureStripe\Stripe\PaymentMethod $payment_method ID of the payment method used with this SetupAttempt.
 * @property \SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $payment_method_details
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $setup_error The error encountered during this attempt to confirm the SetupIntent, if any.
 * @property string|\SimpleSecureWP\SimpleSecureStripe\Stripe\SetupIntent $setup_intent ID of the SetupIntent that this attempt belongs to.
