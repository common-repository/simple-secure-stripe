 ...
 * @property \SimpleSecureWP\SimpleSecureStripe\Stripe\Coupon $coupon Hash describing the coupon applied to create this discount.
 * @property string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Customer $customer The ID of the customer associated with this discount.
