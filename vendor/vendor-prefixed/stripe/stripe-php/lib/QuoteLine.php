 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject[] $actions A list of items the customer is being quoted for.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $applies_to Details to identify the subscription schedule the quote line applies to.
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $set_pause_collection Details to modify the pause_collection behavior of the subscription schedule.
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $starts_at Details to identify the earliest timestamp where the proposed change should take effect.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $trial_settings Settings related to subscription trials.
 *
 * @license MIT
