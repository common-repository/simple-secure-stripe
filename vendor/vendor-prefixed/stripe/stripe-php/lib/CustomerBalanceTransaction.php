 ...
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\CreditNote $credit_note The ID of the credit note (if any) related to the transaction.
 * @property string $currency Three-letter <a href="https://www.iso.org/iso-4217-currency-codes.html">ISO currency code</a>, in lowercase. Must be a <a href="https://stripe.com/docs/currencies">supported currency</a>.
 * @property string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Customer $customer The ID of the customer the transaction belongs to.
 ...
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Invoice $invoice The ID of the invoice (if any) related to the transaction.
