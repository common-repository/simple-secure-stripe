 ...
 * @property \SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $after_completion
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $consent_collection When set, provides configuration to gather active consent from customers.
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $invoice_creation Configuration for creating invoice for payment mode payment links.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\Collection<\Stripe\LineItem> $line_items The line items representing what is being sold.
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $payment_intent_data Indicates the parameters to be passed to PaymentIntent creation during checkout.
 ...
 * @property \SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $phone_number_collection
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $shipping_address_collection Configuration for collecting the customer's shipping address.
 * @property \SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject[] $shipping_options The shipping rate options applied to the session.
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $subscription_data When creating a subscription, the specified configuration data will be used. There must be at least one line item with a recurring price to use <code>subscription_data</code>.
 * @property \SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $tax_id_collection
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $transfer_data The account (if any) the payments will be attributed to for tax reporting, and where funds from each payment will be transferred to.
