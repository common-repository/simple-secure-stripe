 ...
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $application ID of the Connect Application that created the subscription.
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $billing_thresholds Define thresholds at which an invoice will be sent, and the subscription advanced to a new billing period
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $cancellation_details Details about why this subscription was cancelled
 ...
 * @property string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Customer $customer ID of the customer who owns the subscription.
 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\Discount $discount Describes the current discount applied to this subscription, if there is one. When billing, a discount applied to a subscription overrides a discount applied on a customer-wide basis.
 * @property null|(string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Discount)[] $discounts The discounts applied to the subscription. Subscription item discounts are applied before subscription discounts. Use <code>expand[]=discounts</code> to expand each discount.
 * @property null|int $ended_at If the subscription has ended, the date the subscription ended.
 * @property \SimpleSecureWP\SimpleSecureStripe\Stripe\Collection<\Stripe\SubscriptionItem> $items List of subscription items, each with an attached price.
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Invoice $latest_invoice The most recent invoice this subscription has generated.
 ...
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Account $on_behalf_of The account (if any) the charge was made on behalf of for charges associated with this subscription. See the Connect documentation for details.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $pause_collection If specified, payment collection for this subscription will be paused.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $payment_settings Payment settings passed on to invoices created by the subscription.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $pending_invoice_item_interval Specifies an interval for how often to bill for any pending invoice items. It is analogous to calling <a href="https://stripe.com/docs/api#create_invoice">Create an invoice</a> for the given subscription at the specified interval.
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\SetupIntent $pending_setup_intent You can use this <a href="https://stripe.com/docs/api/setup_intents">SetupIntent</a> to collect user authentication when creating a subscription without immediate payment or updating a subscription's payment method, allowing you to optimize for off-session payments. Learn more in the <a href="https://stripe.com/docs/billing/migration/strong-customer-authentication#scenario-2">SCA Migration Guide</a>.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $pending_update If specified, <a href="https://stripe.com/docs/billing/subscriptions/pending-updates">pending updates</a> that will be applied to the subscription once the <code>latest_invoice</code> has been paid.
 ...
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\SubscriptionSchedule $schedule The schedule attached to the subscription
 ...
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\TestHelpers\TestClock $test_clock ID of the test clock this subscription belongs to.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $transfer_data The account (if any) the subscription's payments will be attributed to for tax reporting, and where funds from each payment will be transferred to for each of the subscription's invoices.
...
class Subscription extends ApiResource
{
     ...
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\Subscription the updated subscription
     */
     ...
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\Subscription the canceled subscription
     */
     ...
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\Subscription the resumed subscription
     */
     ...
     * @throws \SimpleSecureWP\SimpleSecureStripe\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\SearchResult<\Stripe\Subscription> the subscription search results
     */
