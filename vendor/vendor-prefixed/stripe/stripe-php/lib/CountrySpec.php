 ...
 * @property \SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $supported_bank_account_currencies Currencies that can be accepted in the specific country (for transfers).
 ...
 * @property \SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject $verification_fields
 *
 * @license MIT
