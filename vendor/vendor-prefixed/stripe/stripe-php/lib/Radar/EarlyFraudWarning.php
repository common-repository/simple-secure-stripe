...
namespace SimpleSecureWP\SimpleSecureStripe\Stripe\Radar;
 ...
 * @property string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Charge $charge ID of the charge this early fraud warning is for, optionally expanded.
 ...
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\PaymentIntent $payment_intent ID of the Payment Intent this early fraud warning is for, optionally expanded.
 *
 * @license MIT
 * Modified by sswp-bot on 26-December-2023 using Strauss.
 * @see https://github.com/BrianHenryIE/strauss
 */
class EarlyFraudWarning extends \SimpleSecureWP\SimpleSecureStripe\Stripe\ApiResource
{
