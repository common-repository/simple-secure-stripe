 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\Collection<\Stripe\FileLink> $links A list of <a href="https://stripe.com/docs/api#file_links">file links</a> that point at this file.
...
class File extends ApiResource
{
     ...
     *
     * @return \SimpleSecureWP\SimpleSecureStripe\Stripe\File the created file
     */
    public static function create($params = null, $opts = null)
    {
        ...
        $flatParams = \array_column(\SimpleSecureWP\SimpleSecureStripe\Stripe\Util\Util::flattenParams($params), 1, 0);
