 ...
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject[] $discounts The discounts applied to the line item.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\Price $price The price used to generate the line item.
 * @property null|string|\SimpleSecureWP\SimpleSecureStripe\Stripe\Product $product <p>The ID of the product for this line item.</p><p>This will always be the same as <code>price.product</code>.</p>
 * @property null|int $quantity The quantity of products being purchased.
 * @property null|\SimpleSecureWP\SimpleSecureStripe\Stripe\StripeObject[] $taxes The taxes applied to the line item.
 *
 * @license MIT
