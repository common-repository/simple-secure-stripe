...
namespace SimpleSecureWP\SimpleSecureStripe\DI\Invoker;
...
class FactoryParameterResolver implements ParameterResolver
{
    ...
    public function getParameters(
        ...
        foreach ($parameters as $index => $parameter) {
            ...
            if ($parameterClass === 'SimpleSecureWP\SimpleSecureStripe\Psr\Container\ContainerInterface') {
                $resolvedParameters[$index] = $this->container;
            } elseif ($parameterClass === 'SimpleSecureWP\SimpleSecureStripe\DI\Factory\RequestedEntry') {
