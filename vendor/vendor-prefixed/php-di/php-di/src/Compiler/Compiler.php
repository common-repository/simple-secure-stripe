...
use SimpleSecureWP\SimpleSecureStripe\DI\Definition\DecoratorDefinition;
...
use SimpleSecureWP\SimpleSecureStripe\DI\Definition\Source\DefinitionSource;
...
use SimpleSecureWP\SimpleSecureStripe\Opis\Closure\SerializableClosure;
use function rename;
    ...
    private function compileDefinition(string $entryName, Definition $definition) : string
    {
        ...
        switch (true) {
            ...
            case $definition instanceof StringDefinition:
                ...
                $code = 'return \SimpleSecureWP\SimpleSecureStripe\DI\Definition\StringDefinition::resolveExpression(' . $entryName . ', ' . $expression . ', $this->delegateContainer);';
                break;
        ...
        if (!$isOptional) {
            throw new \SimpleSecureWP\SimpleSecureStripe\DI\Definition\Exception\InvalidDefinition("The environment variable '{$definition->getVariableName()}' has not been defined");
        }
        return $defaultValue;
PHP;
                break;
    ...
    /**
     * @throws \SimpleSecureWP\SimpleSecureStripe\DI\Definition\Exception\InvalidDefinition
     */
