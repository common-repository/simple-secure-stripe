...
use SimpleSecureWP\SimpleSecureStripe\DI\Definition\FactoryDefinition;
use SimpleSecureWP\SimpleSecureStripe\DI\Definition\Helper\DefinitionHelper;
use SimpleSecureWP\SimpleSecureStripe\DI\Definition\InstanceDefinition;
use SimpleSecureWP\SimpleSecureStripe\DI\Definition\ObjectDefinition;
use SimpleSecureWP\SimpleSecureStripe\DI\Definition\Resolver\DefinitionResolver;
use SimpleSecureWP\SimpleSecureStripe\DI\Definition\Resolver\ResolverDispatcher;
use SimpleSecureWP\SimpleSecureStripe\DI\Definition\Source\DefinitionArray;
use SimpleSecureWP\SimpleSecureStripe\DI\Definition\Source\MutableDefinitionSource;
use SimpleSecureWP\SimpleSecureStripe\DI\Definition\Source\ReflectionBasedAutowiring;
use SimpleSecureWP\SimpleSecureStripe\DI\Definition\Source\SourceChain;
use SimpleSecureWP\SimpleSecureStripe\DI\Definition\ValueDefinition;
use SimpleSecureWP\SimpleSecureStripe\DI\Invoker\DefinitionParameterResolver;
use SimpleSecureWP\SimpleSecureStripe\DI\Proxy\ProxyFactory;
use InvalidArgumentException;
use SimpleSecureWP\SimpleSecureStripe\Invoker\Invoker;
use SimpleSecureWP\SimpleSecureStripe\Invoker\InvokerInterface;
use SimpleSecureWP\SimpleSecureStripe\Invoker\ParameterResolver\AssociativeArrayResolver;
use SimpleSecureWP\SimpleSecureStripe\Invoker\ParameterResolver\Container\TypeHintContainerResolver;
...
class Container implements ContainerInterface, FactoryInterface, InvokerInterface
{
     ...
     *                             The array can also contain DI definitions, e.g. SimpleSecureWP\SimpleSecureStripe\DI\get().
     *
