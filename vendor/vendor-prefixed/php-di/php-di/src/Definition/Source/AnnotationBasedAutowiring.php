...
use SimpleSecureWP\SimpleSecureStripe\DI\Annotation\Inject;
use SimpleSecureWP\SimpleSecureStripe\DI\Annotation\Injectable;
use SimpleSecureWP\SimpleSecureStripe\DI\Definition\Exception\InvalidAnnotation;
use SimpleSecureWP\SimpleSecureStripe\DI\Definition\ObjectDefinition;
use SimpleSecureWP\SimpleSecureStripe\DI\Definition\ObjectDefinition\MethodInjection;
use SimpleSecureWP\SimpleSecureStripe\DI\Definition\ObjectDefinition\PropertyInjection;
use SimpleSecureWP\SimpleSecureStripe\DI\Definition\Reference;
use Doctrine\Common\Annotations\AnnotationRegistry;
use Doctrine\Common\Annotations\Reader;
use Doctrine\Common\Annotations\SimpleAnnotationReader;
use InvalidArgumentException;
use SimpleSecureWP\SimpleSecureStripe\PhpDocReader\PhpDocReader;
use ReflectionClass;
...
class AnnotationBasedAutowiring implements DefinitionSource, Autowiring
{
    ...
    private function readProperty(ReflectionProperty $property, ObjectDefinition $definition, $classname = null)
    {
        ...
        $annotation = $this->getAnnotationReader()->getPropertyAnnotation($property, 'SimpleSecureWP\SimpleSecureStripe\DI\Annotation\Inject');
    ...
    private function getMethodInjection(ReflectionMethod $method)
    {
        // Look for @Inject annotation
        try {
            $annotation = $this->getAnnotationReader()->getMethodAnnotation($method, 'SimpleSecureWP\SimpleSecureStripe\DI\Annotation\Inject');
    ...
    public function getAnnotationReader()
    {
        if ($this->annotationReader === null) {
            ...
            $this->annotationReader->addNamespace('SimpleSecureWP\SimpleSecureStripe\DI\Annotation');
        }
    ...
    private function readInjectableAnnotation(ReflectionClass $class, ObjectDefinition $definition)
    {
        try {
            ...
            $annotation = $this->getAnnotationReader()
                ->getClassAnnotation($class, 'SimpleSecureWP\SimpleSecureStripe\DI\Annotation\Injectable');
